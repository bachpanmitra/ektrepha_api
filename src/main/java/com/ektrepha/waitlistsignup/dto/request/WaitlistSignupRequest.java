...
public record WaitlistSignupRequest(
		...
		@NotBlank @Pattern(regexp = "childcare|senior_care|adult_care|pet_care|tutoring",
				message = "must be one of childcare, senior_care, adult_care, pet_care, tutoring") String interest,
